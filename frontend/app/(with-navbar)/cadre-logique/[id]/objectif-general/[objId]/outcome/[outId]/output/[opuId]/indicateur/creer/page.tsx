...
export default function CreerIndicateurPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!opuId) {
      setError("L'output sélectionné est introuvable (opuId manquant).");
      setLoading(false);
      return;
    }
    const payload = {
  ...
  return (
    <main className="p-6 max-w-lg mx-auto">
      <h1 className="text-2xl font-bold mb-4">Créer un indicateur</h1>
